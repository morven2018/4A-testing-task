export default function Warranty() {
  return (
    <div className="flex flex-col gap-7.5 p-4.25 border border-[#484D4E] rounded-[30px]  max-w-304">
      ...
      <p className="font-normal text-2xl text-[#DCDCDC] pr-5 tracking-wider">
